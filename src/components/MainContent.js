...
const MainContent = () => (
  <div className="container-fluid">
    ...
    <div id="team" style={sectionStyle}>
      ...
      <div className="row mt-3 text-center">
        <div className="col-md-4 mb-4">
          <img src="/sambridh.jpeg" alt="Team Member" style={teamStyle} />
          <h4 className="mt-2">Sambridh</h4>
          <p>CEO</p>
        </div>
        <div className="col-md-4 mb-4">
          <img src="/siddhart.jpeg" alt="Team Member" style={teamStyle} />
          <h4 className="mt-2"> Siddhart</h4>
          <p>CTO</p>
        </div>
        <div className="col-md-4 mb-4">
          <img src="/abhi.jpeg" alt="Team Member" style={teamStyle} />
          <h4 className="mt-2">Abhi</h4>
          <p>CFO</p>
        </div>
        <div className="col-md-4 mb-4">
          <img src="/Luja.jpeg" alt="Team Member" style={teamStyle} />
          <h4 className="mt-2"> Luja</h4>
          <p>COO</p>
        </div>
        <div className="col-md-4 mb-4">
          <img src="/prabek.jpeg" alt="Team Member" style={teamStyle} />
          <h4 className="mt-2">Prabek</h4>
          <p>Marketing Head</p>
        </div>
        <div className="col-md-4 mb-4">
          <img src="/sajana.jpeg" alt="Team Member" style={teamStyle} />
